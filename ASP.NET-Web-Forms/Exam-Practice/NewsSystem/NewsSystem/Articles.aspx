        ...
        <asp:ListView runat="server" ID="ListViewArticles" ItemType="NewsSystem.Models.Article" DataKeyNames="Id"
            ...
            <LayoutTemplate>
                <asp:Panel runat="server" ID="PanelSortOptions" CssClass="container">
                    ...
                    <asp:LinkButton Text="Sort by Category" runat="server" ID="LinkButtonCaterory" CssClass="col-md-2 btn btn-default" CommandName="Sort" CommandArgument="Category.Name" />
            ...
            <ItemTemplate>
                <div class="row">
                    ...
                    <asp:Label ID="LabelArticleContent" runat="server" Text='<%# Item.Content.ToString() + "..." %>' />
