namespace PriorityQueueWithHeap
{
    using System;
    ...
    public class Program
    {
        ...
        {
            var q = new PriorityQueue<string, Product>(new MyStringComparer());
            ...
            q.Add(new KeyValuePair<string, Product>(a.Name, a));
            q.Add(new KeyValuePair<string, Product>(b.Name, b));
            q.Add(new KeyValuePair<string, Product>(c.Name, c));
    ...
    public class MyProductComparer : IComparer<Product>
    {
        public int Compare(Product x, Product y)
        {
            ...
            if (compare == 0)
            {
                compare = x.Category.CompareTo(y.Category);
            }
